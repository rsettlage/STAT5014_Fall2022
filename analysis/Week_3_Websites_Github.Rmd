...
We are going to host on GitHub, so start by making a new repo on GitHub.  We want this to be our personal website, so we need to name it special in order for GitHub to publish it correctly.
...
Go ahead and add a README.md with a title and text in it.  
